package com.bhattarai.stringsdemo.stringexample;
...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(j!=346);
		
//		String s = "       hello      world   ";
//		String s2= " hello ";
//		System.out.println(Arrays.toString(s2.split("l")));
...
//		System.out.println("s.substring(0, 3): " + s2.substring(2, 5));		//  he
